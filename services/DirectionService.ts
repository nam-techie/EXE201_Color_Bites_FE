import { DEFAULT_ROUTE_ALTERNATIVES, OPENROUTE_API_KEY, ROUTE_OPTIMIZATION_PARAMS, TRANSPORT_COSTS } from "@/constants"
...
export function convertCoordinatesToMapFormat(coordinates: number[][]): { latitude: number; longitude: number }[] {
