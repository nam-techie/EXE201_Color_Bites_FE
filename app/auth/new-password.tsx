   ...
   return (
      <SafeAreaView style={styles.container}>
         ...
         <View style={styles.statusBar}>
            <Text style={styles.statusTime}>12:57</Text>
         ...
         <View style={styles.content}>
            ...
            {/* Set Password Button */}
            <TouchableOpacity 
               style={[styles.setPasswordButton, (!isPasswordValid() || isLoading) && styles.setPasswordButtonDisabled]}
               onPress={handleSetNewPassword}
               disabled={!isPasswordValid() || isLoading}
            >
               <Text style={[styles.setPasswordButtonText, (!isPasswordValid() || isLoading) && styles.setPasswordButtonTextDisabled]}>
