...
export default function RestaurantDetailModal({ restaurant, visible, onClose }: Props) {
    ...
    const getDietaryInfo = () => {
        const info = []
        if (restaurant.tags["diet:vegetarian"] === "yes" || restaurant.tags["diet:vegetarian"] === "only") {
            info.push("Chay")
        }
            ...
            <View style={styles.container}>
                ...
                <ScrollView style={styles.scrollView} contentContainerStyle={styles.scrollContent}>
                    ...
                    <View style={styles.cuisineContainer}>
                        <Text style={styles.cuisineIcon}>{getCuisineIcon(restaurant.tags.cuisine || "")}</Text>
                        ...
                        <View style={styles.amenitiesContainer}>
                            ...
                            {restaurant.tags.smoking === "no" && (
                                <View style={[styles.amenityTag, styles.redTag]}>
                                    <Text style={[styles.amenityText, styles.redText]}>🚭 Không hút thuốc</Text>
                                </View>
                            )}
                            {restaurant.tags.indoor_seating === "yes" && (
                                <View style={[styles.amenityTag, styles.purpleTag]}>
                                    <Text style={[styles.amenityText, styles.purpleText]}>🏠 Chỗ ngồi trong nhà</Text>
                                </View>
                            )}
                            {restaurant.tags.outdoor_seating === "yes" && (
                                <View style={[styles.amenityTag, styles.yellowTag]}>
                                    <Text style={[styles.amenityText, styles.yellowText]}>🌤️ Chỗ ngồi ngoài trời</Text>
                                </View>
                            )}
                        </View>
                    </View>
