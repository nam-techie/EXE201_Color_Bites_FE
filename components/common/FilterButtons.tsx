      ...
      >
        {filters.map((filter) => (
          <TouchableOpacity
            ...
            style={[
              styles.filterButton,
              selectedFilter === filter.key ? styles.selectedButton : styles.unselectedButton,
            ]}
          >
            <Text style={styles.filterIcon}>{filter.icon}</Text>
            <Text
              style={[styles.filterText, selectedFilter === filter.key ? styles.selectedText : styles.unselectedText]}
            >
              {filter.label}
            </Text>
          </TouchableOpacity>
