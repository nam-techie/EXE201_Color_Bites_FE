                        ...
                        >
                            <View style={styles.alternativeHeader}>
                                <View style={styles.routeNumber}>
                                    <Text style={[styles.routeNumberText, isSelected && styles.selectedRouteNumberText]}>
                                        {index + 1}
                                    </Text>
                                </View>
                                <View style={styles.routeInfo}>
                                    <Text style={[styles.routeTitle, isSelected && styles.selectedRouteTitle]}>
                                        Tuyến đường {index + 1}
                                    </Text>
                                    <View style={styles.routeStats}>
                                        <View style={styles.statItem}>
                                            <Ionicons name="location" size={12} color={isSelected ? "#3B82F6" : "#6B7280"} />
                                            <Text style={[styles.statText, isSelected && styles.selectedStatText]}>
                                                {formatDistance(alternative.distance)}
                                            </Text>
                                        </View>
                                        <View style={styles.statItem}>
                                            <Ionicons name="time" size={12} color={isSelected ? "#3B82F6" : "#6B7280"} />
                                            <Text style={[styles.statText, isSelected && styles.selectedStatText]}>
                                        ...
                                        {estimatedCost > 0 && (
                                            <View style={styles.statItem}>
                                                <Ionicons name="card" size={12} color={isSelected ? "#3B82F6" : "#6B7280"} />
                                                <Text style={[styles.statText, isSelected && styles.selectedStatText]}>
