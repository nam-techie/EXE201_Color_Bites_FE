...
export default function CustomMarker({
   ...
   const isVegetarian =
      restaurant.tags['diet:vegetarian'] === 'yes' || restaurant.tags['diet:vegetarian'] === 'only'
   const isVegan =
      restaurant.tags['diet:vegan'] === 'yes' || restaurant.tags['diet:vegan'] === 'only'
      ...
      >
         <View style={styles.markerWrapper}>
            ...
            >
               ...
               {/* Cuisine icon */}
               <Text style={[styles.markerText, { fontSize: markerSize * 0.4 }]}>
                  {cuisineIcon}
               </Text>
               ...
               <View style={styles.statusIndicators}>
                  ...
                  {isVegetarian && !isVegan && (
                     <View style={[styles.statusDot, styles.vegetarianDot]} />
                  )}
